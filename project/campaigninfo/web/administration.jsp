...
.submit input {
 ...
 <div class="header">
              ...
              <form id="js-form">
    <h1 style="color:black; position: relative; left:110px; top: 55px ">Menu</h1>
  <div class="name">
      <br/>
       <br />
  <br />
  <br/> <br/>
   ...
   <div class="submit">
               ...
               <div id="menu">
                                 <ul  style="position:relative; right:420px; bottom:50px  ">
        <li class="active"><a href="addadmin.jsp" style="color:black">Add Admin</a></li>
        
       
         <li class="active"><a href="deladmin.jsp" style="color:black">Delete Admin</a></li>
        <li class="active"><a href="registration.jsp" style="color:black">Add User</a></li>
         <li class="active"><a href="deluser.jsp" style="color:black">Delete User</a></li>
          <li class="active"><a href="updateuser.jsp" style="color:black">Update User</a></li>
                                 </ul>
                                </div>
              
                
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 370px; left:50px ">
