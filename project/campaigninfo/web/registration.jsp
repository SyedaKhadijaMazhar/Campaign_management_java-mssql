...
<form name="myform" action="insert" id="js-form" method="post">
  ...
  <br />
    ...
    <br/> <br/>
     <input type="text" name="email" placeholder="Email Id " style="border-color:black; position:relative; right:2px; width:300 "/>
    <br/> <br/>
  ...
  <br />
    <br />
    <input type="text" name="identityno" placeholder="Identity Card No#" style="border-color:black; position:relative; right:2px; width:300 " />
  </div>
      <br />
      <br />
  </div>
  ...
  <input type="submit" value="Submit"/>
                                ...
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 680px; right: 510px">
