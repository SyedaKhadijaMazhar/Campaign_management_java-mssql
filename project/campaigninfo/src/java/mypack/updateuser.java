...
try{
    String sql="update userregistration set firstname=?,lastname=?,emailid=?,username=?,password=?,cellno=? where identityno=?";
        ...
        pst.setString(7, g);
                    pst.executeUpdate();
                   RequestDispatcher rd=request.getRequestDispatcher("updatemsg.jsp"); 
