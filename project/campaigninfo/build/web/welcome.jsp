...
.submit input {
 ...
 <div class="header">
                ...
                <form action="" id="js-form" style="position:relative; top:80px ">
    <h1 style="color:black; position: relative; left:65px; top: 55px ">Welcome User!</h1>
  <div class="name">
      <br/>
       <br />
       <br />
  <br/> <br/>
   ...
   <div class="submit">
               ...
               <div id="menu">
                                 <ul  style="position:relative; right:360px; top:50px  ">
        <li class="active"><a href="addcampaign.jsp" style="color:black">Master Campaign</a></li>
        
       
        
                
		<li class="active"><a href="addproducts.jsp"style="color:black">Master Products</a></li>
		<li class="active"><a href="addest.jsp"style="color:black">Estimated Budget Campaign</a></li>
                
                  <li class="active"><a href="addact.jsp"style="color:black">Actual Budget Campaign</a></li></ul>
                                </div>
              
                
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 360px; left:180px ">
		...
		<li class="active"><a href="aboutus.jsp">About Us</a></li>
                ...
                <h3 style="position:relative; bottom:230px "><a href="index.jsp">Logout</a></h3>
