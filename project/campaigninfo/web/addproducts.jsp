...
Connection connection = 
         DriverManager.getConnection
            ("jdbc:sqlserver://localhost:1433;" + "databaseName=campaign;user=sa;password=p@ssw0rd;");

       Statement statement = connection.createStatement() ;

       resultset =statement.executeQuery("select * from addproductcategory") ;
%>
        		<div id="logo">
 ...
 <div class="header">
                ...
                <form action="productinsert" id="js-form" method="post">
      <h1 style="color:black">Add New Products</h1>
  <div class="name">
      
    <input style="position:relative; top:15px; right:2px; width:300; border-color:black" type="text" name="companyname" placeholder="Company Name" />
  
    <input style="position:relative; top:30px; border-color:black"  type="text" name="units" placeholder="Units" />
  </div>

  <div  class="dropdown">
      <label style="position:relative; top:30px; " for="select-choice"><h3>Product Category</h3></label>
    <select style="border-color:black" name="selectcategory" id="select-choice" placeholder="Select">
  ...
  <div class="message" >
      <label style="position:relative; top:30px; " for="textarea"><h3>Product Details:</h3></label>
...
%>
                                ...
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 625px; right: 510px">
