...
.submit input {
 ...
 <div class="header">
                ...
                <form action="passchange" id="js-form" method="post">
  ...
  <br />
    ...
    <input type="text" name="password" placeholder="New Password " style="border-color:black; position:relative; right:2px; width:300 "/>
    <br/> <br/>
  ...
  <input type="submit" value="Submit"/>
                                ...
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 445px; right: 510px">
