<%-- 
    Document   : stati
    Created on : Jan 15, 2017, 9:52:37 AM
    Author     : SOFIA SYED
--%>
...
<form action="selectall" id="js-form" method="post" style="position:relative; right:400px ">
 <h1 style="color:black">To Select All Campaigns Statistics</h1>
  <div class="name">
      <br/>
       <br/> <br/>
    <br />
  ...
  <input type="submit" value="Submit"/>
                ...
                <form action="estall" id="js-form" method="post" style="position:relative; right:80px; bottom:25px  ">
                    <h1 style="color:black">To Select All Estimated Campaigns Statistics</h1>
  <div class="name">
      <br/>
      <br/>
    <br/>  
 ...
 <div class="submit">
  <input type="submit" value="Submit"/>
                ...
                <form action="actall" id="js-form" method="post" style="position:relative; left:240px; bottom:50px  ">
      <h1 style="color:black">To Select All Actual Campaigns Statistics</h1>
 ...
 <div class="submit">
  <input type="submit" value="Submit"/>
                ...
                <div id="menu" style="position:relative; bottom:985px; right:510px  ">
                                 <ul  >
