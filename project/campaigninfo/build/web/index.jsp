...
.submit input {
 ...
 <div class="header">
                ...
                <form action="validate" id="js-form" method="post">
    <h1 style="color:black; position: relative; left:110px ">Login</h1>
  <div class="name">
      <br/>
    ...
    <br />
  <br />
   <h2 style="position:relative; left: 85px">Username</h2>
   <input type="text" name="username" style="border-color:black; position:relative; right:2px; width:300 "  />
    <br/> <br/>
    <h2 style="position:relative; left: 90px"> Password</h2>
    <input type="password" name="password" style="border-color:black; position:relative; right:2px; width:300" />
    <br />
    <br />
    <p style="color:black">  Not a member? <a href="registration.jsp">Click Here</a></p>
    <p style="color:black">Forgot your password? <a href="changepass.jsp">Click Here</a></p>
  ...
  <input type="submit" value="Submit"/>
		...
		<li class="active"><a href="aboutus.jsp">About Us</a></li>
                ...
                <p style="position:relative; top:100px "><a href="adminlogin.jsp">Admin Portal</a></p>
<div class= "foot">
  <footer>
<br />  
    <br />
