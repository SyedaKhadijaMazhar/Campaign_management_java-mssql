 ...
 <div class="header">
  ...
  <br/> <br/>
   ...
   <div class="submit">
               ...
               <div id="menu">
                                 <ul  style="position:relative; right:470px; bottom:50px  ">
        <li class="active"><a href="addact.jsp" style="color:black">Add Actual Budget Campaign</a></li>
        
       
        
                
		
                <li class="active"><a href="actdel.jsp" style="color:black">Delete Actual Budget Campaign</a></li></ul>
                                </div>
              
                
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 370px; right:60px ">
