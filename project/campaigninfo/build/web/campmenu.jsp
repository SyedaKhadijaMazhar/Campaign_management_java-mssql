 ...
 <div class="header">
  ...
  <br/> <br/>
   ...
   <div class="submit">
               ...
               <div id="menu">
                                 <ul  style="position:relative; right:560px; bottom:50px  ">
        <li class="active"><a href="addcampaign.jsp" style="color:black">Add Campaign</a></li>
        
       
        
                
		
                <li class="active"><a href="delcampaign.jsp"style="color:black">Delete Campaign</a></li></ul>
                                </div>
              
                
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 370px; right:220px ">
