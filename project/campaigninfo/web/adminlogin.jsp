...
.submit input {
 ...
 <div class="header">
                ...
                <form action="adminvalidate" id="js-form" method="post">
    <h1 style="color:black; position: relative; left:70px ">Admins Login</h1>
  <div class="name">
      <br/>
  ...
  <input type="submit" value="Submit"/>
                            ...
                            <p style="position:relative; top:100px "><a href="index.jsp">Home Page</a></p>
<div class= "foot">
  <footer>
<br />  
    <br />
