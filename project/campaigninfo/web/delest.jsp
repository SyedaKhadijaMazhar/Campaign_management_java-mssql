...
.submit input {
 ...
 <div class="header">
                ...
                <form action="campdel" id="js-form" method="post">
    <h1 style="color:black">Delete Estimated Campaign</h1>
  <div class="name">
      <br/>
      
    <input type="text" name="campaignname" placeholder="Campaign Name" style="border-color:black; position:relative; right:2px; width:300; top:20px  "/>
    <br />
  <br />
   <br/> <br/>
   </div>
  ...
  <input type="submit" value="Delete"/>
                                ...
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 450px; right:510px ">
