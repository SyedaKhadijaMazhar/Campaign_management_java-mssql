...
/****** Object:  Database [campaign]    Script Date: 1/23/2017 10:40:05 AM ******/
CREATE DATABASE [campaign]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'campaign', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\campaign.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'campaign_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\campaign_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [campaign] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [campaign] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [campaign] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [campaign] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
