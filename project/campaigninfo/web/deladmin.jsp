...
.submit input {
 ...
 <div class="header">
                ...
                <form action="admindel" id="js-form" method="post">
    <h1 style="color:black">Delete Admin</h1>
  <div class="name">
      <br/>
      
    <input type="text" name="email" placeholder="Email" style="border-color:black; position:relative; right:2px; width:300; top:20px  "/>
    <br />
  <br />
