...
.submit input {
 ...
 <div class="header">
                ...
                <form action="prodel" id="js-form" method="post">
    <h1 style="color:black">Delete Product</h1>
  <div class="name">
      <br/>
      
    <input type="text" name="companyname" placeholder="Company Name" style="border-color:black; position:relative; right:2px; width:300; top:20px  "/>
    <br />
  <br />
