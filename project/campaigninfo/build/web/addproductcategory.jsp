...
.submit input {
 ...
 <div class="header">
                ...
                <form action="addcategory" id="js-form" method="post">
    <h1 style="color:black">Add Product Category</h1>
  <div class="name">
      <br/>
      
    <input type="text" name="productcategory" placeholder="add here" style="border-color:black; position:relative; right:2px; width:300 "/>
    <br />
  <br />
  ...
  <input type="submit" value="Submit"/>
                                ...
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 390px; right: 510px">
