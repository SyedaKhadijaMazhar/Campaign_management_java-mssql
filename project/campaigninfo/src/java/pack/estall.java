...
public class estall extends HttpServlet {
...
try
{
   ...
   if (!conexion.isClosed())
   {
      ...
      out.println("<table border=\"1\"><tr><td>Campaign Name</td><td>Start Date</td><td>End Date</td><td>license No#</td><td>Campaign Details</td><td>Estimated Budget</td><td>Actual Budget</td>");
      while (rs.next())
      {
         out.println("<tr>");
         ...
         out.println("<td>"+rs.getObject("estimatedbudget")+"</td>");
