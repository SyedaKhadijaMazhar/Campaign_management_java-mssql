...
.submit input {
 ...
 <div class="header">
                ...
                <form action="userdel" id="js-form" method="post">
    <h1 style="color:black">Delete User</h1>
  <div class="name">
      <br/>
      
    <input type="text" name="emailid" placeholder="Email" style="border-color:black; position:relative; right:2px; width:300; top:20px  "/>
    <br />
  <br />
  ...
  <input type="submit" value="Delete"/>
		...
		<li class="active"><a href="aboutusjsp">About Us</a></li>
