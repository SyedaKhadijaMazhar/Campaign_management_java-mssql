 ...
 <div class="header">
  ...
  <br/> <br/>
   ...
   <div class="submit">
               ...
               <div id="menu">
                                 <ul  style="position:relative; right:480px; bottom:50px  ">
        <li class="active"><a href="addproducts.jsp" style="color:black">Add Product</a></li>
        
       
         <li class="active"><a href="delproduct.jsp"style="color:black">Delete Product</a></li>
        <li class="active"><a href="addproductcategory"style="color:black">Add Product Category</a></li></ul>
                                </div>
              
                
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 370px; right:80px ">
