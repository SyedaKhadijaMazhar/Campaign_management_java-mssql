 ...
 <div class="header">
  ...
  <br/> <br/>
   ...
   <div class="submit">
               ...
               <div id="menu">
                                 <ul  style="position:relative; right:440px; bottom:50px  ">
        <li class="active"><a href="addest.jsp" style="color:black">Add Estimated Budget Campaign</a></li>
        
       
        
                
		
                <li class="active"><a href="delest.jsp" style="color:black">Delete Estimated Budget Campaign</a></li></ul>
                                </div>
              
                
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 370px; right:10px ">
