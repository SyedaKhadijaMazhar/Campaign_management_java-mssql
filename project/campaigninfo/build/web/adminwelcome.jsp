...
.submit input {
 ...
 <div class="header">
              ...
              <form  id="js-form">
    <h1 style="color:black; position: relative; left:55px; top: 55px ">Welcome Admin!</h1>
  <div class="name">
      <br/>
       <br />
  <br />
  <br/> <br/>
   ...
   <div class="submit">
               ...
               <div id="menu">
                                 <ul  style="position:relative; right:240px; bottom:50px  ">
        <li class="active"><a href="campmenu.jsp" style="color:black">Master Campaign</a></li>
        
       
        
                
		<li class="active"><a href="promenu.jsp"style="color:black">Master Products</a></li>
		<li class="active"><a href="estmenu.jsp"style="color:black">Estimated Budget Campaign</a></li>
                 <li class="active"><a href="actmenu.jsp"style="color:black">Actual Budget Campaign</a></li>
                  <li class="active"><a href="actmenu.jsp"style="color:black">Administration</a></li>
                  <li class="active"><a href="stati.jsp"style="color:black">Statistics</a></li>
                                ...
                                <div id="menu">
                                 <ul  style="position:relative; bottom: 370px; left:415px ">
        <li class="active"><a href="index.jsp.jsp">Homepage</a></li>
		...
		<li class="active"><a href="aboutus.jsp">About Us</a></li>
                ...
                <h3 style="position:relative; bottom:358px "><a href="adminlogin.jsp">Logout</a></h3>
<div class= "foot">
  <footer>
<br />  
    <br />
